...
@RequiredArgsConstructor //BoardService bs; 생성자만들기
public class BoardController {
	
	private final BoardService bs;
	
	//@RequestMapping(value="/register", method=RequestMethod.GET) , 12라인과 같음
	@GetMapping("/register")
	public void register() throws Exception {
		// void, return값이 없어 /board/register 요청 => WEB-INF/views/board/register.jsp 
	...
	public String modify(BoardVO board, RedirectAttributes rttr) throws Exception{
		// 게시글 수정
		bs.modify(board);
		rttr.addAttribute("bno", board.getBno()); // 77번라인 대신
