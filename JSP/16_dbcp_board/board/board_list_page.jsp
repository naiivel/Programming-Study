...
<%
	...
	int pageCount = 15;  	//한번에 보여줄 게시물 개수
	int startRow = 0;    	//검색 시작 인덱스 번호
	int totalCount = 0;  	//전체 게시물 개수
	int startPage = 0;   	//페이지블럭 시작 페이지 번호
	int endPage = 0;   		//페이지블럭 마지막 페이지 번호
	...
	try {
		...
		//pageCount == 15
		//1page = 0 index (1-1) * 15 = 0
		//2page = 15 index (2-1) * 15 = 15
		//3page = 30 index ... (3-1) * 15 = 30
...
/* 또다른방법*/maxPage = (int)(Math.ceil(totalCount/(double)pageCount));
