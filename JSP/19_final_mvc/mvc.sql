...
SELECT * FROM notice_board ORDER BY n_num DESC limit 0, 10;
...
SELECT Q.*,M.name AS qna_name FROM question_answer AS Q, mvc_member AS M
WHERE Q.qna_writer_num = M.num ORDER BY qna_re_ref DESC, qna_re_seq ASC;
